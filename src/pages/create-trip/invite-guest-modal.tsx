...
export function InviteGuestModal({
    ...
    return (
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center mx-3 md:mx-0'>
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            className='p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex flex-col md:flex-row md:items-center gap-2'
            >
